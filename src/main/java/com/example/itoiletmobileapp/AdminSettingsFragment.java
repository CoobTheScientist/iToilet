...
public class AdminSettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button changeP = view.findViewById(R.id.changeP1);
        changeP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Go to the admin change password fragment
                Navigation.findNavController(v).navigate(R.id.action_adminSettingsFragment_to_adminChangePasswordFragment);
            }
        });
